...
```bash
go install github.com/chainreactors/tui/console/example
```
<!-- ```bash -->
<!-- # Clone the repository and go to example directory -->
<!-- git clone https://github.com/chainreactors/tui/console && cd console/example -->
<!---->
...
Note that these files are also the ones used as demonstration snippets in the [wiki](https://github.com/chainreactors/tui/console/wiki).
